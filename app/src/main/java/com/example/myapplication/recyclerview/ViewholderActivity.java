...
public class ViewholderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewholder_recycler_view);
        initList();
        rvMain = findViewById(R.id.recycler_main);
        rvMain.setLayoutManager(new LinearLayoutManager(ViewholderActivity.this));
        LinearAdapter adapter = new LinearAdapter(list, new LinearAdapter.onItemClickListener() {
            @Override
            public void onClick(int pos) {
                Toast.makeText(ViewholderActivity.this,"达达"+pos,Toast.LENGTH_SHORT).show();
            }
        });
